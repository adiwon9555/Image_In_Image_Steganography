...
public class Steganography_View extends JFrame
{
	 ...
	 */
	public JLabel	getInput()		{ return input;				}
	/*
	 ...
	 */
	public JPanel		getEncodeImagePanel()	{ return new EncodeImagePanel();	}
	/*
	 ...
	 *Class Text_Panel
	 */
	private class EncodeImagePanel extends JPanel
	{
		/*
		...
		public EncodeImagePanel()
		{
			...
			JScrollPane scroll2 = new JScrollPane(input,JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
